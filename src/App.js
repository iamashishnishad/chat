...
function App() {
  ...
  const handleInput = () => {
    ...
    if (words2.test(document.querySelector("#input").value)) {
      ...
      getBotMessage.innerText = "Typing...";
      setTimeout(() => {
        getBotMessage.innerText = "Hi there I'm Wysa-an AI chatbot built by therapists I'm here to understand your concerns and connect you with the best resource availiable to support you Can I help?"; // display the message
    ...
    let words12 = new RegExp(wysa);
    if (words12.test(document.querySelector("#input").value)) {
      getBotMessage.innerText = "Typing...";
      setTimeout(() => {
        getBotMessage.innerText = "An AI chatbot that makes you feel heard";
        inputRef.value = ""; // 
      }, 1000);
    }
    ...
    if (words8.test(document.querySelector("#input").value)) {
      getBotMessage.innerText = "Typing...";
      setTimeout(() => {
        getBotMessage.innerText = "My name is Wysa Tribe ChatBot";
        inputRef.value = ""; // clear the input
      }, 2000);
    }
    ...
    if (words9.test(document.querySelector("#input").value)) {
      getBotMessage.innerText = "Typing...";
      setTimeout(() => {
        getBotMessage.innerText = "The owner of this bot is Wysa Tribe";
        inputRef.value = ""; // clear the input
      }, 2000);
    }
      ...
      <div className="wrapper">
        <div className="content">
          <div className="header">
            ...
            <div className="right">
              <div className="name">Wysa Tribe ChatBot</div>
